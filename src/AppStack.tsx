      ...
      <div className="container">
        ...
        <div className="post-layout">
          <div className="votecell post-layout--left">
            <div
              className="js-voting-container grid jc-center fd-column ai-stretch gs4 fc-black-200"
              data-post-id={160536}
            >
              <button
              ...
              <div
                id="--stacks-s-tooltip-bhipfegj"
                className="s-popover s-popover__tooltip pe-none"
                aria-hidden="true"
                role="tooltip"
              >
                This question does not show any research effort; it is unclear
                or not useful
                <div className="s-popover--arrow" />
              </div>
              <button
                ...
                aria-describedby="--stacks-s-tooltip-6yyc9ku1"
              >
                <svg
                  aria-hidden="true"
              ...
              <a
                ...
                href="/posts/160536/timeline"
                data-shortcut="T"
                data-ks-title="timeline"
                data-controller="s-tooltip"
                data-s-tooltip-placement="right"
                aria-label="Timeline"
                aria-describedby="--stacks-s-tooltip-8ezgjxf4"
              >
                <svg
                  aria-hidden="true"
          ...
          <div className="postcell post-layout--right">
            <div className="s-prose js-post-body" itemProp="text">
              <p>
                For new Q&amp;A sites, does Stack Exchange offer their framework
                so that other teams can create new sites or is it all in-house?
              </p>
            </div>
            <div className="mt24 mb12">
              <div className="post-taglist grid gs4 gsy fd-column">
                <div className="grid ps-relative">
                  <a
                    href="/questions/tagged/discussion"
                    className="post-tag required-tag js-gps-track"
                    rel="tag"
                  >
                    discussion
                  </a>{' '}
                  <a
                    href="/questions/tagged/stack-exchange"
                    className="post-tag js-gps-track"
                    title="show questions tagged 'stack-exchange'"
                    rel="tag"
                  >
                    stack-exchange
                  </a>
                    ...
                    <div className="grid d-flex gs8 s-anchors s-anchors__muted fw-wrap">
                      <div className="grid--cell">
                        <a
                          ...
                          rel="nofollow"
                          itemProp="url"
                          className="js-share-link js-gps-track"
                        ...
                        <div
                          className="s-popover z-dropdown s-anchors s-anchors__default"
                          style={{width: 'unset', maxWidth: '28em'}}
                          id="se-share-sheet-0"
                        >
                          <div className="s-popover--arrow" />
                          <div>
                            <span className="js-title fw-bold">
                              Share a link to this question
                            </span>{' '}
                            <span className="js-subtitle" />
                          </div>
                          <div className="my8">
                            <input
                              type="text"
                          ...
                          <div className="d-flex jc-space-between ai-center mbn4">
                            <button className="js-copy-link-btn s-btn s-btn__link">
                              Copy link
                            </button>
                            <a
                              href="https://creativecommons.org/licenses/by-sa/3.0/"
                              rel="license"
                              className="js-license s-block-link"
                              target="_blank"
                              title="The current license for this post: CC BY-SA 3.0"
                            >
                              CC BY-SA 3.0
                            </a>
                      ...
                      <div className="grid--cell">
                        <a
                          href="/posts/160536/edit"
                          className="js-suggest-edit-post js-gps-track"
                          data-gps-track="post.click({ item: 6, priv: 0, post_type: 1 })"
                        >
                      ...
                      <div className="grid--cell">
                        <button
                          type="button"
                          id="btnFollowPost-160536"
                          className="s-btn s-btn__link js-follow-post js-follow-question js-gps-track"
                          data-gps-track="post.click({ item: 14, priv: 0, post_type: 1 })"
                          data-controller="s-tooltip "
                          data-s-tooltip-placement="bottom"
                          data-s-popover-placement="bottom"
                          aria-describedby="--stacks-s-tooltip-uavhxonp"
                        >
                          Follow
                        </button>
                        <div
                          id="--stacks-s-tooltip-uavhxonp"
                          className="s-popover s-popover__tooltip pe-none"
                          aria-hidden="true"
                          role="tooltip"
                        >
                ...
                <div className="post-signature grid--cell">
                  <div className="user-info user-hover">
                    <div className="user-action-time">
                      <a
                        href="/posts/160536/revisions"
                        title="show all edits to this post"
                        className="js-gps-track"
                        data-gps-track="post.click({ item: 4, priv: 0, post_type: 1 })"
                      >
                        edited{' '}
                        <span
                          title="2012-12-27 21:31:25Z"
                    ...
                    <div className="user-gravatar32">
                      <a href="/users/155160/adam-lear">
                        <div className="gravatar-wrapper-32">
                          <img
                            src="https://i.stack.imgur.com/8gs0B.png?s=32&g=1"
                            alt=""
                            width={32}
                            height={32}
                            className="bar-sm"
                    ...
                    <div className="user-details">
                      <a href="/users/155160/adam-lear">Adam Lear</a>
                      <span className="mod-flair " title="moderator">
                        ♦
                      </span>
                      <div className="-flair">
                        <span
                          className="reputation-score"
                          title="reputation score 148,510"
                          dir="ltr"
                        >
                          149k
                        </span>
                        <span title="46 gold badges" aria-hidden="true">
                          <span className="badge1" />
                          <span className="badgecount">46</span>
                        </span>
                        <span className="v-visible-sr">46 gold badges</span>
                        <span title="441 silver badges" aria-hidden="true">
                          <span className="badge2" />
                          <span className="badgecount">441</span>
                        </span>
                        <span className="v-visible-sr">441 silver badges</span>
                        <span title="629 bronze badges" aria-hidden="true">
                          <span className="badge3" />
                          <span className="badgecount">629</span>
                        </span>
                        <span className="v-visible-sr">629 bronze badges</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="user-info ">
                    ...
                    <div className="user-gravatar32">
                      <a href="/users/205721/rickd">
                        <div className="gravatar-wrapper-32">
                          <img
                            src="https://i.stack.imgur.com/MDQWA.jpg?s=32&g=1"
                            alt=""
                            width={32}
                            height={32}
                            className="bar-sm"
                    ...
                    >
                      <a href="/users/205721/rickd">RickD</a>
                      ...
                      <div className="-flair">
                        ...
                        <span title="2 bronze badges" aria-hidden="true">
                          <span className="badge3" />
                          <span className="badgecount">2</span>
                        </span>
                        <span className="v-visible-sr">2 bronze badges</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <span className="d-none" itemProp="commentCount">
            1
          </span>
          <div className="post-layout--right js-post-comments-component">
            <div
              id="comments-160536"
              className="comments js-comments-container bt bc-black-075 mt12 "
              data-post-id={160536}
              data-min-length={15}
            >
              <ul
                className="comments-list js-comments-list"
              ...
              >
                <li
                  id="comment-465502"
                  className="comment js-comment "
                  data-comment-id={465502}
                  data-comment-owner-id={161198}
                  ...
                  <div className="comment-text  js-comment-text-and-form">
                    <div className="comment-body js-comment-edit-hide">
                      <span className="comment-copy">
                        If you're looking to host your own SO-like site, a clone
                        might be of interest:{' '}
                        <a
                          href="http://meta.stackexchange.com/questions/2267/stack-overflow-clones"
                          title="stack overflow clones"
                        >
                          meta.stackexchange.com/questions/2267/stack-overflow-clones
                        </a>
                      </span>
                      –&nbsp;
                      <a
                        href="/users/161198/bart"
                        title="59,691 reputation"
                      ...
                      <span className="comment-date" dir="ltr">
                        <a
                          ...
                          href="#comment465502_160536"
                        >
                          <span
                            title="2012-12-27 19:56:41Z, License: CC BY-SA 3.0"
                            className="relativetime-clean"
                          >
                            Dec 27 '12 at 19:56
                          </span>
                        </a>
            ...
            <div id="comments-link-160536" data-rep={5} data-anon="true">
              <a
                className="js-add-link comments-link disabled-link"
                title="Use comments to ask for clarification or add more information. Avoid answering questions in comments."
                href="#"
                role="button"
              >
                Add a comment
              ...
              <a
                className="js-show-link comments-link dno"
