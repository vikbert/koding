...
export default function RulePopup(props: RulePopupProps) {
  ...
  function handleAddSnippet() {
    const updatedRule = {...rule, snippets: [editorState.snippetId, ...rule.snippets || []]}
        ...
        <div className="popup rule-popup">
          ...
          <div className="content">
            ...
            {rule.snippets && (
                <div className="container my-2">
                  ...
                  {rule.snippets.map((snippetId: string) => snippetId && (<li key={snippetId} className={'small'}>{snippetId}</li>))}
                </div>
            )}
          </div>
          ...
          <div className="action">
            ...
            {editorState.snippetId && (
                <>
                  <button className={'is-primary is-cleared is-error'} onClick={handleAddSnippet}>add snippet</button>
                </>
            )}
