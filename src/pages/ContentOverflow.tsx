        ...
        <div id="mainbar">
          ...
          <div id="qlist-wrapper" className="flush-left">
            <div id="question-mini-list">
              <div>
                <div
                  className="question-summary narrow"
                  id="question-summary-67499960"
                >
                  <div className="cp">
                    <div className="votes">
                  ...
                  <div className="summary">
                    <h3>
                      <a
                        href="/questions/67499960/i-have-to-output-my-data-from-database-and-also-copy-all-inputs-from-form-to-sen"
                        className="question-hyperlink"
                      >
                        I have to output my data from DataBase and also copy all
                        inputs from form to send them to myself, including
                        real-time multiplying weight*pcs
                      </a>
                    </h3>
                    ...
                    <div className="started">
                      <a
                        href="/questions/67499960/i-have-to-output-my-data-from-database-and-also-copy-all-inputs-from-form-to-sen/?lastactivity"
                        className="started-link"
                      >
                        answered{' '}
                        <span
                          title="2021-05-13 07:41:16Z"
                          className="relativetime"
                        >
                          16 mins ago
                        </span>{' '}
                      </a>
                      <a href="/users/15904743/szymon-%c5%bburaw">
                        Szymon Żuraw
                      </a>{' '}
                      <span
                ...
                >
                  ...
                  <div className="summary">
                    <h3>
                      <a
                        href="/questions/67515241/javascript-difference-dates-with-120s"
                        className="question-hyperlink"
                      >
                        Javascript - Difference dates with 120s
                      </a>
                    </h3>
                    <div className="subcommunities float-left"></div>
                    <div className="tags t-momentjs">
                      <a
                        href="/questions/tagged/momentjs"
                        className="post-tag"
                        rel="tag"
                      >
                        momentjs
                    ...
                    <div className="started">
                      <a
                        href="/questions/67515241/javascript-difference-dates-with-120s/?lastactivity"
                        className="started-link"
                      >
                        answered{' '}
                        <span
                          title="2021-05-13 07:41:12Z"
                          className="relativetime"
                        >
                          16 mins ago
                        </span>{' '}
                      </a>
                      <a href="/users/7823152/althelazymonkey">
                        AlTheLazyMonkey
                      </a>{' '}
                      <span
                        className="reputation-score"
                ...
                <div
                  className="question-summary narrow tagged-interesting"
                  id="question-summary-67515324"
                >
                  <div className="cp">
                    <div className="votes">
                      <div className="mini-counts">
                        <span title="1 vote">1</span>
                      </div>
                      <div>vote</div>
                    </div>
                  ...
                  <div className="summary">
                    <h3>
                      <a
                        href="/questions/67515324/what-is-type-of-toisostring"
                        className="question-hyperlink"
                      >
                        what is type of toISOString
                      </a>
                    </h3>
                    <div className="subcommunities float-left"></div>
                    <div className="tags t-javascript t-reactjs t-typescript">
                      ...
                      <a
                        href="/questions/tagged/typescript"
                        className="post-tag"
                        rel="tag"
                      >
                        typescript
                    ...
                    <div className="started">
                      ...
                      >
                        modified{' '}
                        <span
                          title="2021-05-13 07:40:04Z"
                          className="relativetime"
                        >
                          17 mins ago
                        </span>{' '}
                      </a>
                      <a href="/users/209259/erik-philips">Erik Philips</a>{' '}
                      <span
                        className="reputation-score"
                        title="reputation score 48,468"
                        dir="ltr"
                      >
                        48.5k
                      </span>
          ...
          >
            <ul className="d-block p0 m0">
              ...
              <li className="s-sidebarwidget--item grid px16">
                ...
                <div className="grid--cell wmn0 ow-break-word">
                  <a
                    href="https://meta.stackexchange.com/questions/364007/testing-three-vote-close-and-reopen-on-13-network-sites?cb=1"
                    className="js-gps-track"
              ...
              <li className="s-sidebarwidget--item grid px16">
                ...
                <div className="grid--cell wmn0 ow-break-word">
                  <a
                    href="https://meta.stackexchange.com/questions/364048/we-are-switching-to-system-fonts-on-may-10-2021?cb=1"
                    className="js-gps-track"
              ...
              <li className="s-sidebarwidget--item grid px16">
                ...
                <div className="grid--cell wmn0 ow-break-word">
                  <a
                    href="https://meta.stackoverflow.com/questions/407613/outdated-answers-flagging-exercise-begins-today?cb=1"
                    className="js-gps-track"
              ...
              <li className="s-sidebarwidget--item grid px16">
                ...
                <div className="grid--cell wmn0 ow-break-word">
                  <a
                    href="https://meta.stackoverflow.com/questions/407563/triage-no-minimal-example-given?cb=1"
                    className="js-gps-track"
              ...
              <li className="s-sidebarwidget--item grid px16">
                ...
                <div className="grid--cell wmn0 ow-break-word">
                  <a
                    href="https://meta.stackoverflow.com/questions/407578/request-for-moderation-new-user-asked-and-deleted-own-questions-including-good?cb=1"
                    className="js-gps-track"
                  ...
                  >
                    Request for moderation: New user asked and deleted own
                    questions including…
                  </a>
                </div>
              </li>
              <li className="s-sidebarwidget--item grid px16">
                ...
                <div className="grid--cell wmn0 ow-break-word">
                  <a
                    href="https://meta.stackoverflow.com/questions/407612/you-are-the-weakest-link-goodbye?cb=1"
                    className="js-gps-track"
                    ...
                    data-gps-track="communitybulletin.click({ priority: 7, position: 7 })"
                  >
                    You are the [weak]est link - goodbye!
                  </a>
                </div>
              </li>
            </ul>
